...
const Hero = () => {
  return (
    <div class="w-full flex flex-col p-1 gap-2 items-center bg-blue-950 ">
      ...
      <h2 class="text-4xl text-white text-center">I'm <span className="kalam">Stephen Katuli,</span> a <span class="text-secondary-focus">Full Stack developer</span> </h2>
      <p class="text-white text-center w-full max-w-sm text-lg">I use my experience in programming to create visually stunning and user-friendly websites to help bring your vision to life and create a website that your users will love.</p>
