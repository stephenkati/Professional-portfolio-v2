...
const Hero = () => {
  return (
    <div className="w-full flex flex-col p-1 gap-2 items-center bg-blue-950 mt-24">
      ...
      <h2 className="text-4xl text-white text-center">I'm <span className="kalam">Stephen Katuli,</span> a <span className="text-secondary">Full Stack developer</span> </h2>
